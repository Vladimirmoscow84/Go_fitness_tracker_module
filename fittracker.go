...
// meanSpeed - значение средней скорости движения во время тренировки.
//
// action int — количество совершенных действий(число шагов при ходьбе и беге, либо гребков при плавании).
//
...
// ShowTrainingInfo - информациея о тренировке.
//
// action int — количество совершенных действий(число шагов при ходьбе и беге, либо гребков при плавании).
...
// RunningSpentCalories - количество потраченных колорий при беге.
//
// action int — количество совершенных действий(число шагов при ходьбе и беге, либо гребков при плавании).
...
// WalkingSpentCalories - количество потраченных калорий при ходьбе.
//
// action int — количество совершенных действий(число шагов при ходьбе и беге, либо гребков при плавании).
// duration float64 — длительность тренировки в часах.
// weight float64 — вес пользователя.
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	c := (k1 + k3) * duration * minInH
	fmt.Printf("k1: %.2f, k2: %.2f, k3: %.2f, c: %.2f\n", k1, k2, k3, c)
	return c
}
...
// swimmingMeanSpeed - средняя скорость при плавании.
//
...
// SwimmingSpentCalories - количество потраченных калорий при плавании.
//
// Параметры:
//
// lengthPool int — длина бассейна в метрах.
